...
module.exports = (env, argv) => {
  ...
  console.log(isProduction ? "프로덕션모드 입니다" : "개발모드 입니다");
  return {
    // mode: "development", // 개발모드인지 프로덕션모드인지 설정해줍니다. env도 가능
    entry: isProduction ? "./src/lib/index.tsx" : "./src/index.js", // 웹팩 번들링을 할 파일
    output: {
    ...
    module: {
      rules: [
        {
          test: /\.(js|jsx|tsx)$/, // js와 jsx의 확장자를 가진 것은 바벨 로더를 거침
